...
:startInstallation
  ...
  set SERVICE_NAME=AutmaisSplitXml
  set SERVICE_DESCRIPTION=AutmaisSplitXml

  :: replace with the absolute path where node.exe can be found
  nssm install %SERVICE_NAME% "%HOME%\.venv\Scripts\python.exe"
  ...
  nssm set %SERVICE_NAME% AppParameters "%HOME%\main.py"
